...
const CategoriasPage: React.FC = () => {
  ...
  const handleDelete = async (id: number) => {
    if (!window.confirm(t('¿Estás seguro de que quieres eliminar esta categoría?', 'Are you sure you want to delete this category?'))) {
      return;
    }
  ...
  return (
    <Container maxWidth="xl" sx={{ mt: 4, mb: 4 }}>
      ...
      {loading ? (
        <Typography color="text.secondary">{t('Cargando categorías...', 'Loading categories...')}</Typography>
      ) : categorias.length === 0 ? (
